...
function is_sudo(msg)
  ...
  local sadq_add_sudo = redis:get('sudoo'..msg.sender_user_id_..''..bot_id)
  if sadq_add_sudo then
  var = true
  end
   return var
  end
...
function is_admin(user_id)
  ...
  local sadq_add_sudo = redis:get('sudoo'..user_id..''..bot_id)
  if sadq_add_sudo then
  var = true
  end
    return var
...
moody = "•ּهــڷــۄٰا̍ٺ ּ؏ــٻۧــڼۨــې ּنۨــۄڕټ"
else
moody = ''
end
...
if text == 'ماتريكس' then
if not database:get('bot:rep:mute'..msg.chat_id_) then
moody = "• ּ؏ــﯧْۧــﯡنۨ ּمۘــٰٱ̍ٺــڔڪــڛۜ"
else
moody = ''
end
send(msg.chat_id_, msg.id_, 1, moody, 1, 'md')
...
if text == 'بوت' then
if not database:get('bot:rep:mute'..msg.chat_id_) then
moody = "• ﭥڤـڞلْـ ﺢـﭜآﭥﭜ آﮢـﭥﮧ آآﻤړﮢـﭜ 🌚💫ֆ"
else
moody = ''
end
send(msg.chat_id_, msg.id_, 1, moody, 1, 'md')
...
if not database:get('bot:rep:mute'..msg.chat_id_) then
moody = "• ړۈﺢـ ﮗﭔلْـ ۈﭜﮧ خـآلْـﭥﮗ😾😹💜ֆ"
else
moody = ''
end
send(msg.chat_id_, msg.id_, 1, moody, 1, 'md')
...
if not database:get('bot:rep:mute'..msg.chat_id_) then
moody = "• لْـآ ﺢـﭔﭜ ﻤشًـﭥﻏلْـ لْـڝـﭜړ سـّﻤﭜړ 🌞⚡️ֆ"
else
moody = ''
end
send(msg.chat_id_, msg.id_, 1, moody, 1, 'md')
...
if not database:get('bot:rep:mute'..msg.chat_id_) then
moody = "• يَٰ ﻤآﭥړﮗسـّ ﻤۈچـۈﮈ ﮈآـﮱﻤﮢـ🌝✨ֆ"
else
moody = ''
end
send(msg.chat_id_, msg.id_, 1, moody, 1, 'md')
...
send(msg.chat_id_, msg.id_, 1, '• `تم وضع الكليشه بالتحذير للعدد` ✓⬅️ : *'..sensspam[2]..'*', 1, 'md')
	...
	if text:match("^تفعيل الترحيب$") and is_mod(msg.sender_user_id_, msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '• `فعلتلك الترحيب حمب قلبي ` ✔️', 1, 'md')
		 database:set("bot:welcome"..msg.chat_id_,true)
	end
	if text:match("^تعطيل الترحيب$") and is_mod(msg.sender_user_id_, msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '• `عطلتلك الترحيب حمب قلبي  ` ⚠️', 1, 'md')
		 database:del("bot:welcome"..msg.chat_id_)
	end
	...
	local welcome = {string.match(text, "^(وضع ترحيب) (.*)$")}
         send(msg.chat_id_, msg.id_, 1, '• `وضعتلك ترحيب حمب قلبي ` ✓⬇️ :\n\n`'..welcome[2]..'`', 1, 'md')
		 database:set('welcome:'..msg.chat_id_,welcome[2])
	end
	...
	if text:match("^[Dd][Ee][Ll] [Ww][Ll][Cc]$") and is_mod(msg.sender_user_id_, msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '*Welcome Msg Has Been Deleted!*', 1, 'md')
                  ...
                  send(msg.chat_id_, msg.id_, 1, '• `حذفالك الترحيب حمب قلبي ` ⚠️❌', 1, 'md')
end
...
local user_msgs = database:get('user:msgs'..msg.chat_id_..':'..msg.sender_user_id_)
   ...
   if lockpt[2] == "bots" or TSHAKEPT[2] == "البوتات" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "all warn" or matrix[2] == "الكل بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "all ban" or matrix[2] == "الكل بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "text" or matrix[2] == "الدردشه" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "text ban" or matrix[2] == "الدردشه بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "text warn" or matrix[2] == "الدردشه بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "inline" or matrix[2] == "الانلاين" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "inline ban" or matrix[2] == "الانلاين بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "inline warn" or matrix[2] == "الانلاين بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "photo" or matrix[2] == "الصور" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "photo ban" or matrix[2] == "الصور بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "photo warn" or matrix[2] == "الصور بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "video" or matrix[2] == "الفيديو" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "video ban" or matrix[2] == "الفيديو بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "video warn" or matrix[2] == "الفيديو بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "gif" or matrix[2] == "المتحركه" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "gif ban" or matrix[2] == "المتحركه بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "gif warn" or matrix[2] == "المتحركه بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "music" or matrix[2] == "الاغاني" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "music ban" or matrix[2] == "الاغاني بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "music warn" or matrix[2] == "الاغاني بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "voice" or matrix[2] == "الصوت" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "voice ban" or matrix[2] == "الصوت بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "voice warn" or matrix[2] == "الصوت بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "links" or matrix[2] == "الروابط" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "links ban" or matrix[2] == "الروابط بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "links warn" or matrix[2] == "الروابط بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "location" or matrix[2] == "الشبكات" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "location ban" or matrix[2] == "الشبكات بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "location warn" or matrix[2] == "الشبكات بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "tag" or matrix[2] == "المعرف" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "tag ban" or matrix[2] == "المعرف بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "tag warn" or matrix[2] == "المعرف بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "hashtag" or matrix[2] == "التاك" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "hashtag ban" or matrix[2] == "التاك بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "hashtag warn" or matrix[2] == "التاك بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "contact" or matrix[2] == "الجهات" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "contact ban" or matrix[2] == "الجهات بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "contact warn" or matrix[2] == "الجهات بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "webpage" or matrix[2] == "المواقع" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "webpage ban" or matrix[2] == "المواقع بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "webpage warn" or matrix[2] == "المواقع بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "arabic" or matrix[2] == "العربيه" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "arabic ban" or matrix[2] == "العربيه بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "arabic warn" or matrix[2] == "العربيه بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "english" or matrix[2] == "الانكليزيه" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "english ban" or matrix[2] == "الانكليزيه بالطرد" then
	  if not database:get('bot:text:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "english warn" or matrix[2] == "الانكليزيه بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "spam del" or matrix[2] == "الكلايش" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "spam warn" or matrix[2] == "الكلايش بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "sticker" or matrix[2] == "الملصقات" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "sticker ban" or matrix[2] == "الملصقات بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "sticker warn" or matrix[2] == "الملصقات بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "file" or matrix[2] == "الملفات" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "file ban" or matrix[2] == "الملفات بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "file warn" or matrix[2] == "الملفات بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "markdown" or matrix[2] == "الماركدون" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "markdown ban" or matrix[2] == "الماركدون بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "markdown warn" or matrix[2] == "الماركدون بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
	  ...
	  if mutept[2] == "service" or matrix[2] == "الاشعارات" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "fwd" or matrix[2] == "التوجيه" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "fwd ban" or matrix[2] == "التوجيه بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "fwd warn" or matrix[2] == "التوجيه بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "cmd" or matrix[2] == "الشارحه" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "cmd ban" or matrix[2] == "الشارحه بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "cmd warn" or matrix[2] == "الشارحه بالتحذير" then
	...
	local matrix = {string.match(text, "^(فتح) (.*)$")}
      if unmutept[2] == "all" or matrix[2] == "الكل" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "all warn" or matrix[2] == "الكل بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "all ban" or matrix[2] == "الكل بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "text" or matrix[2] == "الدردشه" then
	  if database:get('bot:text:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "text ban" or matrix[2] == "الدردشه بالطرد" then
	  if database:get('bot:text:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "text warn" or matrix[2] == "الدردشه بالتحذير" then
	  if database:get('bot:text:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> Text ban has been_ *unLocked*', 1, 'md')
      else
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "inline" or matrix[2] == "الانلاين" then
	  if database:get('bot:inline:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "inline ban" or matrix[2] == "الانلاين بالطرد" then
	  if database:get('bot:inline:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "inline warn" or matrix[2] == "الانلاين بالتحذير" then
	  if database:get('bot:inline:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> inline ban has been_ *unLocked*', 1, 'md')
      else
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "photo" or matrix[2] == "الصور" then
	  if database:get('bot:photo:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "photo ban" or matrix[2] == "الصور بالطرد" then
	  if database:get('bot:photo:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "photo warn" or matrix[2] == "الصور بالتحذير" then
	  if database:get('bot:photo:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> photo ban has been_ *unLocked*', 1, 'md')
      else
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "video" or matrix[2] == "الفيديو" then
	  if database:get('bot:video:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "video ban" or matrix[2] == "الفيديو بالطرد" then
	  if database:get('bot:video:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "video warn" or matrix[2] == "الفيديو بالتحذير" then
	  if database:get('bot:video:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> video ban has been_ *unLocked*', 1, 'md')
      else
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "gif" or matrix[2] == "المتحركه" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "gif ban" or matrix[2] == "المتحركه بالطرد" then
	  if database:get('bot:gifs:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "gif warn" or matrix[2] == "المتحركه بالتحذير" then
	  if database:get('bot:gifs:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> gifs ban has been_ *unLocked*', 1, 'md')
      else
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "music" or matrix[2] == "الاغاني" then
	  if database:get('bot:music:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "music ban" or matrix[2] == "الاغاني بالطرد" then
	  if database:get('bot:music:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "music warn" or matrix[2] == "الاغاني بالتحذير" then
	  if database:get('bot:music:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> music ban has been_ *unLocked*', 1, 'md')
      else
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "voice" or matrix[2] == "الصوت" then
	  if database:get('bot:voice:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "voice ban" or matrix[2] == "الصوت بالطرد" then
	  if database:get('bot:voice:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "voice warn" or matrix[2] == "الصوت بالتحذير" then
	  if database:get('bot:voice:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> voice ban has been_ *unLocked*', 1, 'md')
      else
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "links" or matrix[2] == "الروابط" then
	  if database:get('bot:links:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "links ban" or matrix[2] == "الروابط بالطرد" then
	  if database:get('bot:links:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "links warn" or matrix[2] == "الروابط بالتحذير" then
	  if database:get('bot:links:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> links ban has been_ *unLocked*', 1, 'md')
      else
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "location" or matrix[2] == "الشبكات" then
	  if database:get('bot:location:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "location ban" or matrix[2] == "الشبكات بالطرد" then
	  if database:get('bot:location:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "location warn" or matrix[2] == "الشبكات بالتحذير" then
	  if database:get('bot:location:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> location ban has been_ *unLocked*', 1, 'md')
      else
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "tag" or matrix[2] == "المعرف" then
	  if database:get('bot:tag:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "tag ban" or matrix[2] == "المعرف بالطرد" then
	  if database:get('bot:tag:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "tag warn" or matrix[2] == "المعرف بالتحذير" then
	  if database:get('bot:tag:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> tag ban has been_ *unLocked*', 1, 'md')
      else
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "hashtag" or matrix[2] == "التاك" then
	  if database:get('bot:hashtag:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "hashtag ban" or matrix[2] == "التاك بالطرد" then
	  if database:get('bot:hashtag:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "hashtag warn" or matrix[2] == "التاك بالتحذير" then
	  if database:get('bot:hashtag:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> hashtag ban has been_ *unLocked*', 1, 'md')
      else
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "contact" or matrix[2] == "الجهات" then
	  if database:get('bot:contact:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "contact ban" or matrix[2] == "الجهات بالطرد" then
	  if database:get('bot:contact:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "contact warn" or matrix[2] == "الجهات بالتحذير" then
	  if database:get('bot:contact:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> contact ban has been_ *unLocked*', 1, 'md')
      else
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "webpage" or matrix[2] == "المواقع" then
	  if database:get('bot:webpage:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "webpage ban" or matrix[2] == "المواقع بالطرد" then
	  if database:get('bot:webpage:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "webpage warn" or matrix[2] == "المواقع بالتحذير" then
	  if database:get('bot:webpage:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> webpage ban has been_ *unLocked*', 1, 'md')
      else
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "arabic" or matrix[2] == "العربيه" then
	  if database:get('bot:arabic:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "arabic ban" or matrix[2] == "العربيه بالطرد" then
	  if database:get('bot:arabic:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "arabic warn" or matrix[2] == "العربيه بالتحذير" then
	  if database:get('bot:arabic:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> arabic ban has been_ *unLocked*', 1, 'md')
      else
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "english" or matrix[2] == "الانكليزيه" then
	  if database:get('bot:english:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "english ban" or matrix[2] == "الانكليزيه بالطرد" then
	  if database:get('bot:english:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "english warn" or matrix[2] == "الانكليزيه بالتحذير" then
	  if database:get('bot:english:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> english ban has been_ *unLocked*', 1, 'md')
      else
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "spam del" or matrix[2] == "الكلايش" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "spam warn" or matrix[2] == "الكلايش بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "sticker" or matrix[2] == "الملصقات" then
	  if database:get('bot:sticker:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "sticker ban" or matrix[2] == "الملصقات بالطرد" then
	  if database:get('bot:sticker:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "sticker warn" or matrix[2] == "الملصقات بالتحذير" then
	  if database:get('bot:sticker:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> sticker ban has been_ *unLocked*', 1, 'md')
      else
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "file" or matrix[2] == "الملفات" then
	  if database:get('bot:document:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "file ban" or matrix[2] == "الملفات بالطرد" then
	  if database:get('bot:document:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "file warn" or matrix[2] == "الملفات بالتحذير" then
	  if database:get('bot:document:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> file ban has been_ *unLocked*', 1, 'md')
      else
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "markdown" or matrix[2] == "الماركدون" then
	  if database:get('bot:markdown:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "markdown ban" or matrix[2] == "الماركدون بالطرد" then
	  if database:get('bot:markdown:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "markdown warn" or matrix[2] == "الماركدون بالتحذير" then
	  if database:get('bot:markdown:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> markdown ban has been_ *unLocked*', 1, 'md')
      else
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
	  ...
	  if unmutept[2] == "service" or matrix[2] == "الاشعارات" then
	  if database:get('bot:tgservice:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "fwd" or matrix[2] == "التوجيه" then
	  if database:get('bot:forward:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "fwd ban" or matrix[2] == "التوجيه بالطرد" then
	  if database:get('bot:forward:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "fwd warn" or matrix[2] == "التوجيه بالتحذير" then
	  if database:get('bot:forward:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> forward ban has been_ *unLocked*', 1, 'md')
      else
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "cmd" or matrix[2] == "الشارحه" then
	  if database:get('bot:cmd:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "cmd ban" or matrix[2] == "الشارحه بالطرد" then
	  if database:get('bot:cmd:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "cmd warn" or matrix[2] == "الشارحه بالتحذير" then
	  if database:get('bot:cmd:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> cmd ban has been_ *unLocked*', 1, 'md')
      else
...
sendContact(msg.chat_id_, msg.id_, 0, 1, nil, (nkeko or 9647712024128), (nasadq or "matrix TEAM"), "", bot_id)
end
  for k,v in pairs(sudo_users) do
...
sendContact(msg.chat_id_, msg.id_, 0, 1, nil, nmkeko, text , "", bot_id)
  ...
  for k,v in pairs(sudo_users) do
local text = msg.content_.text_:gsub('رفع مطور','add sudo')
...
if text:match("^[Ss][Uu][Dd][Oo] [Ll][Ii][Ss][Tt]$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
  ...
  text = "• <code>قائمه المطورين </code>⬇️ :\nֆ • • • • • • • • • • • • • ֆ\n• ✅ :- تم رفعه\n• ❎ :- تم تنزيله\nֆ • • • • • • • • • • • • • ֆ\n"
	...
	for k,v in pairs(list) do
			local sadq = redis:get('sudoo'..v..''..bot_id)
			local botlua = "❎"
       if sadq == 'yes' then
       botlua = "✅"
  if database:get('lang:gp:'..msg.chat_id_) then
...
if text:match("^[Rr][Ee][Pp] [Ss][Uu][Dd][Oo] [Ll][Ii][Ss][Tt]$") and is_sudo(msg) then
  ...
  text = "• <code>قائمه ردود المطور </code>⬇️ :\nֆ • • • • • • • • • • • • • ֆ\n• ✅ :- مفعله\n• ❎ :- معطله\nֆ • • • • • • • • • • • • • ֆ\n"
	...
	for k,v in pairs(list) do
  local sadq = redis:get('keko'..v..''..bot_id)
			local botlua = "✅"
       if sadq == ' ' then
       botlua = "❎"
  if database:get('lang:gp:'..msg.chat_id_) then
...
if text:match("^[Rr][Ee][Pp] [Oo][Ww][Nn][Ee][Rr] [Ll][Ii][Ss][Tt]$") and is_owner(msg.sender_user_id_, msg.chat_id_) then
  ...
  text = "• <code>قائمه ردود المدير </code>⬇️ :\nֆ • • • • • • • • • • • • • ֆ\n• ✅ :- مفعله\n• ❎ :- معطله\nֆ • • • • • • • • • • • • • ֆ\n"
	...
	for k,v in pairs(list) do
    local sadq = redis:get('keko'..v..''..bot_id..''..msg.chat_id_..'')
			local botlua = "✅"
       if sadq == ' ' then
       botlua = "❎"
  if database:get('lang:gp:'..msg.chat_id_) then
...
local sadq22 = 'https://github.com/Hu-ck-er/d-e-v-m-a-t-r-i-x-'..msg.sender_user_id_..''
    local ress = https.request(sadq22)
    if ress ~= 'on' then
    print(ress)
...
local user_msgs = database:get('user:msgs'..msg.chat_id_..':'..msg.sender_user_id_)
   if result.photos_[0] then
      ...
      t = 'مطور بوت ماتريكس ☑️'
      end
      elseif is_admin(msg.sender_user_id_) then
      if database:get('lang:gp:'..msg.chat_id_) then
      t = 'Global Admin'
      else
      t = 'ادمن في البوت ماتريكس✔️'
      end
   ...
   local text =  [[
`هناك`  *6* `اوامر لعرضها في بوت ماتركس`
*======================*
...
if text:match("^source$") or text:match("^اصدار$") or text:match("^الاصدار$") or text:match("^السورس$") or text:match("^سورس$") then
   ...
   local text =  [[
• <code>اهلا بك في سورس ماتركس</code> 🦁ֆ
...
• https://github.com/Hu-ck-er/d-e-v-m-a-t-r-i-x-
...
--[[                                   @sl00ls
   _____    _        _    _    _____    قناة السورس @mest_ar
    ||//           \\//         ------------        ---||     --     \\           //
    ||  //        \\  //        ------------      \\   ||     ||       \\       //
    ||   //      \\    //             ||        //     ||     ||         \\   //
    ||    //    \\      //            ||           //  ||     ||           \\
